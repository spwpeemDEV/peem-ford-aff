...
7. เลือกจำนวนคลิป แล้วกดปุ่ม **สร้างรูปและวิดีโอใน Flow**

ระบบจะใช้รูปต้นฉบับเดิมสร้างรูป AI ใหม่แบบ `x1` จากนั้นสร้างวิดีโอ `x1`
และรอให้คลิปเสร็จก่อนเริ่มรอบถัดไปจนครบจำนวนที่เลือก
